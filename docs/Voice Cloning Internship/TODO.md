...
- [ ] Before 2026-08-02 07:15 SGT, finish staging fleet rollout: immutable
  ...
  from 50 to 80. Refresh AWS credentials, apply/verify the any-rejection alarm, push
  the two-slot warm change, bake and fresh-node validate a new AMI/LT version, then
