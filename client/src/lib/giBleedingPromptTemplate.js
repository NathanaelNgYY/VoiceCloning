// Sample lesson instructions: the GI bleeding tutor prompt this app shipped with.
//
// This used to be DEFAULT_CHATBOT_SYSTEM_PROMPT in lib/chatbotSystemPrompt.js, i.e.
// the text every frontend ran whenever nothing was deployed. That made it a
// landmine on a multi-subject platform: a neurology lecture whose prompt fetch
// came back empty would silently teach GI bleeding. It is kept here as authored
// reference material for lecturers to copy from, and is imported by nothing.

export const GI_BLEEDING_PROMPT_TEMPLATE = `# Role & Objective
