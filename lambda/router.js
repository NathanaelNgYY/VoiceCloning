...
export const ROUTES = [
  ...
  { name: 'VoiceProfileFunction', methods: ['GET', 'POST'], pattern: /^\/api\/voice-profile\/(?:activate|active|capacity|mine|ensure|(?:internal|pinned)\/[^/]+)\/?$/u, modulePath: './voice-profile/index.js' },
